  ...
  return (
    ...
    <div className="ClusterApp" style={{"width":scale*1920, "height":scale*720}}>
      ...
      <div className="component"  style={{"top": scale*100+"px", "left": scale*(1920-700)+"px"}}>
        <EngineGauge className="component" id="l_gauge_2" text="Engine" sub_text="(1/min) x1000" max_val={8000} split_num={1000} val={espd*100.0/7000} scale={0.001} width={scale*700} height={scale*560} mirror/>
      </div>
